...
public class AngajatStudent extends Persoana implements AngajatInt, StudentInt{
    ...
    public AngajatStudent(String nume, String prenume, Integer varsta, String firma, Integer experienta, Integer zileConcediu, String facultate, String an, boolean bursa) {
